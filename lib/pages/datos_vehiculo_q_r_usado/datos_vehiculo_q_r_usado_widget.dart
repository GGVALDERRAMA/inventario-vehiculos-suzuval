...
import 'datos_vehiculo_q_r_usado_model.dart';
import '/components/custom_drawer_widget.dart';
export 'datos_vehiculo_q_r_usado_model.dart';

class DatosVehiculoQRUsadoWidget extends StatefulWidget {
  const DatosVehiculoQRUsadoWidget({
    super.key,
    required this.mostrarQrUsadoRegistro,
  });

  final String? mostrarQrUsadoRegistro;

  static String routeName = 'Datos_Vehiculo_QR_Usado';
  static String routePath = '/datosVehiculoQRUsado';

  @override
  State<DatosVehiculoQRUsadoWidget> createState() =>
      _DatosVehiculoQRUsadoWidgetState();
}

class _DatosVehiculoQRUsadoWidgetState extends State<DatosVehiculoQRUsadoWidget>
    with TickerProviderStateMixin {
  late DatosVehiculoQRUsadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DatosVehiculoQRUsadoModel());
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            'Registro Diario Vehículo USADO',
                            ...
                            children: [
                              Padding(
                                ...
                                child: FutureBuilder<
                                  ...
                                  future: queryQRVehiculosUSADOSRecordOnce(
                                    queryBuilder: (qRVehiculosUSADOSRecord) =>
                                        qRVehiculosUSADOSRecord.where(
                                      'PPU',
                                      isEqualTo: widget!.mostrarQrUsadoRegistro,
                                    ),
                                    singleRecord: true,
                                  ),
                              ...
                              onPressed: () async {
                                ...
                                await APPInventarioVehiculosUSADOSRecord
                                    ...
                                    .set(
                                      ...
                                      ppu: widget!.mostrarQrUsadoRegistro,
