...
import 'formulary_q_r_n_e_w_model.dart';
export 'formulary_q_r_n_e_w_model.dart';

class FormularyQRNEWWidget extends StatefulWidget {
  const FormularyQRNEWWidget({
    super.key,
    this.mostrarDatosVehiculo,
  });

  final String? mostrarDatosVehiculo;

  static String routeName = 'Formulary_QR_NEW';
  static String routePath = '/formularyQRNEW';

  @override
  State<FormularyQRNEWWidget> createState() => _FormularyQRNEWWidgetState();
}

class _FormularyQRNEWWidgetState extends State<FormularyQRNEWWidget>
    with TickerProviderStateMixin {
  late FormularyQRNEWModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormularyQRNEWModel());

    _model.kilometrajeTextController ??= TextEditingController();
    _model.kilometrajeFocusNode ??= FocusNode();

    _model.cargaBateriaTextController ??= TextEditingController();
    _model.cargaBateriaFocusNode ??= FocusNode();
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FutureBuilder<List<QRVehiculosNUEVOSRecord>>(
                        future: queryQRVehiculosNUEVOSRecordOnce(
                          queryBuilder: (qRVehiculosNUEVOSRecord) =>
                              qRVehiculosNUEVOSRecord.where(
                                'VIN',
                            isEqualTo: widget!.mostrarDatosVehiculo != null && widget!.mostrarDatosVehiculo != '' ? widget!.mostrarDatosVehiculo : '---NO_MATCH---',
                          ),
                          singleRecord: true,
                        ),
                        builder: (context, snapshot) {
                          ...
                          final containerQRVehiculosNUEVOSRecord =
                              containerQRVehiculosNUEVOSRecordList.isNotEmpty
                                  ? containerQRVehiculosNUEVOSRecordList.first
                                  : null;
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: Align(
                                              ...
                                              child: Text(
                                                valueOrDefault<String>(
                                                  containerQRVehiculosNUEVOSRecord?.vin,
                                                  'VIN',
                                                ),
                                                style: FlutterFlowTheme.of(context)
                                                    .bodyMedium
                                              ...
                                              onPressed: () async {
                                                ...
                                                if (scanned != '-1') {
                                                  context.pushReplacementNamed(
                                                    ...
                                                    queryParameters: {
                                                      'mostrarDatosVehiculo': serializeParam(
                                                        scanned,
                                                        ParamType.String,
                                                      ),
                                                    }.withoutNulls,
                      ...
                      child: Row(
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed(
                                  MenuInventarioNuevosWidget.routeName);
                            },
                            text: 'Volver',
                            icon: Icon(
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.radioButtonValue == null) {
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text(
                                          'Error con estatus del vehículo'),
                                      content: Text(
                              ...
                              final qRVehiculosNUEVOSRecordList = await queryQRVehiculosNUEVOSRecordOnce(
                                queryBuilder: (qRVehiculosNUEVOSRecord) =>
                                    qRVehiculosNUEVOSRecord.where(
                                  'VIN',
                                  isEqualTo: widget!.mostrarDatosVehiculo != null && widget!.mostrarDatosVehiculo != '' ? widget!.mostrarDatosVehiculo : '---NO_MATCH---',
                              ...
                              final containerQRVehiculosNUEVOSRecord = qRVehiculosNUEVOSRecordList.isNotEmpty
                                  ? qRVehiculosNUEVOSRecordList.first
                                  : null;
                              ...
                              await APPInventarioVehiculosNUEVOSRecord
                                  ...
                                  .set(
                                    ...
                                    vin: widget!.mostrarDatosVehiculo,
                                    marca: containerQRVehiculosNUEVOSRecord?.marca,
                                    modelo: containerQRVehiculosNUEVOSRecord?.modelo,
                                    color: containerQRVehiculosNUEVOSRecord?.color,
                                    interno: containerQRVehiculosNUEVOSRecord?.interno,
