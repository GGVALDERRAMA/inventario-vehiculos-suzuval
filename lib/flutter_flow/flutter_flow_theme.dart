...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color accent3 = const Color(0xFF66EE60);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF57636C);
  ...
  late Color accent1 = const Color(0xFF57636C);
  late Color accent2 = const Color(0xFF57636C);
  late Color accent3 = const Color(0xFF57636C);
  late Color accent4 = const Color(0xFF57636C);
  late Color success = const Color(0xFF57636C);
  late Color warning = const Color(0xFF57636C);
  late Color error = const Color(0xFF57636C);
  late Color info = const Color(0xFF57636C);
}
