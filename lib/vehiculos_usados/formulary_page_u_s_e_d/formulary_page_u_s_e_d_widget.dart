...
import 'formulary_page_u_s_e_d_model.dart';
import '/components/custom_drawer_widget.dart';
export 'formulary_page_u_s_e_d_model.dart';

/// Formulario de registro vehículo nuevo
class FormularyPageUSEDWidget extends StatefulWidget {
  const FormularyPageUSEDWidget({super.key});

  static String routeName = 'Formulary_Page_USED';
  static String routePath = '/formularyPageUSED';

  @override
  State<FormularyPageUSEDWidget> createState() =>
      _FormularyPageUSEDWidgetState();
}

class _FormularyPageUSEDWidgetState extends State<FormularyPageUSEDWidget>
    with TickerProviderStateMixin {
  late FormularyPageUSEDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormularyPageUSEDModel());

    _model.ppuTextController ??= TextEditingController();
    _model.ppuFocusNode ??= FocusNode();
    ...
    _model.anioTextController ??= TextEditingController();
    _model.anioFocusNode ??= FocusNode();
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            'Inventariar Vehículo Usado con Formulario',
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.ppuTextController,
                      focusNode: _model.ppuFocusNode,
                      autofocus: true,
                      obscureText: false,
                      ...
                      validator: _model.ppuTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(12.0, 10.0, 8.0, 0.0),
                    child: TextFormField(
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(12.0, 10.0, 8.0, 0.0),
                    child: TextFormField(
                      controller: _model.anioTextController,
                      focusNode: _model.anioFocusNode,
                      autofocus: true,
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'Año',
                      ...
                      validator: _model.anioTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
                  Align(
                            ...
                            onPressed: () async {
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content: Text(
                                          'Falta indicar fecha de vencimiento...'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                              Navigator.pop(alertDialogContext),
                              ...
                              await APPInventarioVehiculosUSADOSRecord
                                  ...
                                  .set(
                                    ...
                                    ppu: _model.ppuTextController.text,
                                    ...
                                    ano: _model.anioTextController.text,
